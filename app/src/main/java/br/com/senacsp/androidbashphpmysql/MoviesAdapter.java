            ...
            public MenuClickListener (int pos) {this.pos=pos;}
                ...
                switch (menuItem.getItemId()) {
                    case R.id.action_favourite:
                        ...
                        return true;
                    case R.id.action_watch:Toast.makeText(context, movies.get(pos).getMovieName() + "is added to watchlist", Toast.LENGTH_SHORT).show();
                        return true;
                    case R.id.action_book:Toast.makeText(context, movies.get(pos).getMovieName() + "is added to watchlist", Toast.LENGTH_SHORT).show();
                        return true;
                        default:
                }
                return false;
